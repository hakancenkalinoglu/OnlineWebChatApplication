...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
	...
	#chat-message{width: 100%;box-sizing: border-box;padding: 10px 8px;color: #191919; border-radius: 6px; border-style: groove; 
	}
	.asd{
  ...
  border: 0;
  background: linear-gradient(100deg, rgba(455, 134, 220, 31), rgba(124, 123, 220, 1));
  display: block;
  margin: 20px auto;
  text-align:  center;
